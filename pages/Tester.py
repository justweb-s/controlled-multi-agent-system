...
"""
Sei un agente architetto software. Il tuo compito è progettare la struttura di un progetto software organizzato, creando le cartelle necessarie, file di documentazione e strumenti di supporto tecnico. Assicurati che la struttura copra tutte le fasi dello sviluppo, dalla raccolta dei requisiti alla progettazione tecnica.
...
def main():
    ...
    user_input_architect = st.chat_input("Scrivi un messaggio per il Architetto:")
    
    if user_input_architect:
        st.session_state.architect_messages.append({"role": "user", "content": user_input_architect})
